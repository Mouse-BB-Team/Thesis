...
The collected data sequences are in form of coordinates' series, so it is necessary to "paint" them as 3-dimensional pictures which are the input for the convolutional neural network.
