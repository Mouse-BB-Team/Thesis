...
For the optimization of the model, the "Adam" loss function with the learning rate fixed at the \num{0.5e-6} point.
This and other setup was experimentally tested, and the given above was giving the best, yet still not very exciting results.