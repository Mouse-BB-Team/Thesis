...
There exist some public datasets mentioned in related works such as the Balabit dataset\upperref{itm:balabit}\blfootnote{\textsuperscript{*} The complete list of links can be found in the \ref{sec:links}ppendices section}\textsuperscript{*} but they are not suitable for the problem of distinguishing a bot from a human.
