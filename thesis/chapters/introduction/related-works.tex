...
However, in those works the ratios of False Acceptance Rate (\gls{far}) and False Rejection Rate (\gls{frr}) were reaching the values above the accepted commercial standards, therefore the systems were still not applicable for real-world scenarios.
...
One of the best available datasets is the Balabit dataset\upperref{itm:pierwsze}.
