...
For the optimization of the model, the optimizer called Adam was used along with the learning rate exponential decay set initially to 1e-4.
The decay rate was equal to 0.96 and the decay steps were set to 1e5.
