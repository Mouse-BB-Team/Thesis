...
In authorization related problems such as raised in this work, there is a desire to have those values as low as possible, because \gls{far} results in the security of the system - the lower the \gls{far} the less unauthorized users have access to the system, and accordingly \gls{frr} has an impact on authorization rejections of legitimate users.
