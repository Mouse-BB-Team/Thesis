...
\supervisor{Piotr Chołda, BEng, PhD, DS}
...
\acknowledgements{We hereby express our thanks to our supervisor – Piotr Chołda, BEng, PhD, DS, which was guiding the process of creation of this thesis. The support in granting the needed resources for the study and feedback provided by Mr. Chołda are invaluable.\\
Special thanks to Krzysztof Rusek BEng, PhD – for consulting the approach for proper machine learning model execution.\\
